...
border_dir_name = "roi_border"
cellpose_dir_name = "cellpose_rois"
manual_dir_name = "manual_rois"
border_dir = os.path.join(experiment_dir, border_dir_name)
cellpose_roi_dir = os.path.join(experiment_dir, cellpose_dir_name)
manual_roi_dir = os.path.join(experiment_dir, manual_dir_name)

generated_folder_list = [cellpose_dir_name, border_dir_name, manual_dir_name]
